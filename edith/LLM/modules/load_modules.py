...
modules = {
    " Text-to-Speech Model -": {
        "loaded": False,
        "progress": 0,
        "file_path": "edith/models/jenny_model/model.pt",
    },
    ...
    " Speech Recognition -": {
        "loaded": False,
        "progress": 0,
        "file_path": "edith/LLM/modules/speech_to_text.py",
    },
    " Audio Processing -": {
        "loaded": False,
        "progress": 0,
    ...
    " Large Language Model -": {
        "loaded": False,
        "progress": 0,
        "file_path": "edith/LLM/llm.py",
    },
    " Hardware Diagnostics -": {
        "loaded": False,
        "progress": 0,
        "file_path": "edith/LLM/modules/system_info.py",
    },
    " Security Modules -": {
        "loaded": False,
        "progress": 0,
        "file_path": "edith/LLM/modules/ghostnet_protocol.py",
    },
    " Virtual Assistant -": {
        "loaded": False,
        "progress": 0,
