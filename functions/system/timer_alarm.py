...
# set_timer_or_alarm("timer for 2 seconds")
...
# def set_alarm(self, hour, minute, am_pm=None):
#     print(hour, minute, am_pm)
#     print(type(hour), type(minute), type(am_pm))  # Fixed the type checking
...
# def parse_time_units(self, command):
#     time_units = {
#         "second": 1,
#         "minute": 60,
#         "hour": 3600,
...
#     elif len(hour_match_plus_ampm.groups()) == 3:
#         hour = int(
#             hour_match_plus_ampm.group(1)
#         )  # Use group(1) instead of groups()[0]
#         time_ = hour_match_plus_ampm.group(2)  # Use group(2) instead of groups()[1]
#         return hour, 0, time_
...
# # Listen to text-based commands
# def set_timer_or_alarm(self, user_input):
#     user_input = user_input.strip().lower()

#     if "timer" in user_input:
#         seconds = self.parse_time_units(user_input)
#         if seconds is not None:
...
#     elif "alarm" in user_input:
#         alarm_time = self.parse_time(user_input)

#         if alarm_time:
#             hour, minute, am_pm = alarm_time
#             self.set_alarm(hour, minute, am_pm)
#         else:
#             pass
